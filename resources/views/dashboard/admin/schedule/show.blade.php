...
<div class="container">
    <div class="row mt-3 mb-5">
        ...
        <div class="text-xl border-2 p-3 max-w-xs shadow-md mx-3">
            <a href="/dashboard/tournaments/{{ $tournament->slug }}/schedules/{{ $schedule->slug }}/create" class="badge bg-hijau border-0">Tambah Hasil Pertandingan</a>
        </div>
                ...
                <tbody>
                    ...
                    @foreach ($results as $result)
                        <tr class="shadow-sm">
                            ...
                            <td>
                                <form action="/dashboard/tournaments/{{ $tournament->slug }}/schedules/{{ $schedule->slug }}/{{ $result->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
